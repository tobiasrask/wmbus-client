    ...
    value: function loadMeterSettings(source, callback) {
      ...
      _fs2.default.readFile(source, function (err, data) {
        ...
        items.forEach(function (row) {
          ...
          // Build meter address
          var meterAddress = Buffer.concat([_meter2.default.reverseBuffer(_meter2.default.buildManufacturerId(row['manufacturer'])), _meter2.default.reverseBuffer(new Buffer(row['serial'], 'hex')), new Buffer(row['version'], 'hex'), new Buffer(row['deviceType'], 'hex')]);
